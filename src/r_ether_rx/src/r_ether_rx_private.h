...
/* This checks to make sure a valid version of the r_bsp package is installed. */
    ...
    #if ((R_BSP_VERSION_MINOR == 60) || (R_BSP_VERSION_MINOR == 80))
    #else
        #warning "This code has been tested with r_bsp v2.60 or v2.80."
        #warning "Any other versions might work; but have not been tested."
    #endif
#else
    #warning "This code has been tested with r_bsp v2.60 or v2.80."
    #warning "Any other versions might work; but have not been tested."

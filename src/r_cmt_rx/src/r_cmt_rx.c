...
*
* Copyright (C) 2013, 2014, 2015 Renesas Electronics Corporation. All rights reserved.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
/* Define the number of CMT channels based on MCU type. */
    ...
    defined(BSP_MCU_RX71_ALL) || defined(BSP_MCU_RX231)
    #define CMT_RX_NUM_CHANNELS        (4)
#elif defined(BSP_MCU_RX111) || defined(BSP_MCU_RX110)
...
/* Starting with RX63x MCUs, there are 2 peripheral clocks: PCLKA and PCLKB. PCLKA is only used by the Ethernet block.
   ...
   used for the CMT on RX210 MCUs too. */
	...
	defined(BSP_MCU_RX71_ALL) || defined(BSP_MCU_RX113) || defined(BSP_MCU_RX231)
